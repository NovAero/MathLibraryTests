...
namespace MathLibraryTests
{
	...
	public:
		...
		TEST_METHOD(ConstructorParamFloats)
		{
			...
			Assert::AreEqual(4.f, mat.m01);
			Assert::AreEqual(5.f, mat.m11);
			Assert::AreEqual(6.f, mat.m21);
			
			Assert::AreEqual(7.f, mat.m02);
			Assert::AreEqual(8.f, mat.m12);
			Assert::AreEqual(9.f, mat.m22);
		}
