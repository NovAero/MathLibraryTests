...
namespace MathLibraryTests
{
    ...
    public:
        ...
        TEST_METHOD(Constructor)
        {
            ...
            Assert::AreEqual(0.f, mat.m00);
            Assert::AreEqual(0.f, mat.m10);
            Assert::AreEqual(0.f, mat.m20);
            Assert::AreEqual(0.f, mat.m30);

            Assert::AreEqual(0.f, mat.m01);
            Assert::AreEqual(0.f, mat.m11);
            Assert::AreEqual(0.f, mat.m21);
            Assert::AreEqual(0.f, mat.m31);

            Assert::AreEqual(0.f, mat.m02);
            Assert::AreEqual(0.f, mat.m12);
            Assert::AreEqual(0.f, mat.m22);
            Assert::AreEqual(0.f, mat.m32);

            Assert::AreEqual(0.f, mat.m03);
            Assert::AreEqual(0.f, mat.m13);
            Assert::AreEqual(0.f, mat.m23);
            Assert::AreEqual(0.f, mat.m33);
        }
        ...
        TEST_METHOD(ConstructorParamFloats)
        {
            ...
            Assert::AreEqual(1.f, mat.m00);
            Assert::AreEqual(2.f, mat.m10);
            Assert::AreEqual(3.f, mat.m20);
            Assert::AreEqual(4.f, mat.m30);

            Assert::AreEqual(5.f, mat.m01);
            Assert::AreEqual(6.f, mat.m11);
            Assert::AreEqual(7.f, mat.m21);
            Assert::AreEqual(8.f, mat.m31);

            Assert::AreEqual(9.f, mat.m02);
            Assert::AreEqual(10.f, mat.m12);
            Assert::AreEqual(11.f, mat.m22);
            Assert::AreEqual(12.f, mat.m32);

            Assert::AreEqual(13.f, mat.m03);
            Assert::AreEqual(14.f, mat.m13);
            Assert::AreEqual(15.f, mat.m23);
            Assert::AreEqual(16.f, mat.m33);
        }
        ...
        TEST_METHOD(MakeIdentity)
        {
            ...
            Assert::AreEqual(0.f, mat.m02);
            Assert::AreEqual(0.f, mat.m12);
            Assert::AreEqual(1.f, mat.m22);
            Assert::AreEqual(0.f, mat.m32);

            Assert::AreEqual(0.f, mat.m03);
            Assert::AreEqual(0.f, mat.m13);
            Assert::AreEqual(0.f, mat.m23);
            Assert::AreEqual(1.f, mat.m33);
        }
    };
}
